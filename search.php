<?php 
	...
	if(isset($_GET["username"]) && !empty($_GET["username"])){
		$temp = "SELECT accounts.id FROM accounts WHERE username = '" . $_GET["username"] . "';";
	...
	$_SESSION["previous"] = $_GET["username"];
						...
						<div class="col-6 col-lg-6 col-md-6">
							<form>
								...
								<select id="type" onchange="javascript:location.href = this.value;">
									<option value="search.php" selected>Posts</option>
								    <option value="search_replies.php">Replies</option>
								</select>
