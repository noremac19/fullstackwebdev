		...
		<?php else: ?>
			<div class="collapse navbar-collapse" id="navbarNavAltMarkup">
		    	<div class="navbar-nav">
		      		...
		      		<a class="nav-item nav-link text-white bold" href="profile_replies.php">Profile</a>
		...
		<div class="row">
			...
			<?php while ( $row = $bio_results->fetch_assoc() ) : ?>	
				...
				<div class="row-flexbox">
					<div id="pic">
						<img src="<?php echo $row['profile_url']; ?>" class="rounded-circle" width="250" height="250">
					</div>
				...
				<div class="hide">
					<form action="bio.php" method="GET" class="col-12" id="search-form">
						<div class="centered">
							<textarea id="url-id" name="url" placeholder="Enter profile image url..." required></textarea>
						</div>
						<div class="row-flexbox">
					...
					<div class="row">
						<div class="col-6 col-lg-6 col-md-6">
							...
							<select id="type" onchange="javascript:location.href = this.value;">
							    ...
							    <option value="profile.php">Posts</option>
							    <option value="profile_replies.php" selected>Replies</option>
							</select>
						</div>
								...
								<div class="container-fluid"> 
									<div class="row space">
										...
										<div class="hold">
											...
											<a href="delete_reply.php?reply_id=<?php echo $row['id']; ?>&account_id=<?php echo $row['account_id']?>" role="button" class="btn btn-primary brown">Delete</a>
										</div>
										...
										<div class="woah hide">
											<form action="edit_reply.php" method="GET" class="col-12" id="search-form">
												<div class="row-flexbox">
													
													<div>
														<label for="edit-id" class="sr-only">Post:</label>
														<textarea id="edit-id" name="edit" required><?php echo $row["reply_text"]; ?></textarea>
													</div>
